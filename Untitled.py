list_a = [["Apexium", "9391899088", "4212", "9000", "19/06/2008"]]#dolakpur_branch

list_b = [["Apexium", "9391899088", "4212", "3000", "19/06/2008"]]#hyderabad_branch

list_c = [["Apexium", "9391899088", "4212", "5000", "19/06/2008"]]#banglore_branch
...
def is_choice_valid(choice):
    if choice in ["DVKCSPKSSRTR", "!@#", "$%^", "&*()"]:
        ...
        if 0 < int(choice) < 19:
            ...
            print("invalid Choice")
            print("Enter a values only between 1 to 18")
            choice = input()
            choice = is_choice_valid(choice)
            return choice
    elif choice.isalpha():
        print("You are entering Alphabets \n Enter values only between 1 to 18")
        print("Try Again")
        choice = input()
        choice = is_choice_valid(choice)
        return choice
    else:
        print("you are entering something not values between 1 to 18")
        print("Try Again")
        choice = input()
        choice = is_choice_valid(choice)
        return choice
...
while True:
    ...
    if number == "0":
        ...
        if choice == "1":
            ...
            print("Choose the branch you want to transfer your Money to: \n 1.Dolkpur Branch \n 2.Hydrabad Branch")
                ...
                if phone == i[1]:
                    ...
                    if Pin == i[2]:
                        ...
                        if int(transfer_amount) <= int(i[3]):
                            receiver_phone = input("Enter the receiver's phone: ")
                            receiver_phone = is_valid_phone(receiver_phone)
                            if receiver_phone == phone:
                                           print("Sender and recever bank is same ")
                            else:
                                for j in list_c:
                                    if receiver_phone == j[1]:
                                        i[3] = str(int(i[3]) - int(transfer_amount))
            ...
            for i in list_c:
                if phone == i[1]:
                    ...
                    Pin = is_valid_Pin(Pin)
                    if Pin == i[2]:
                        print("Please collect your amount :",i[3])
                        list_c.remove(i)
                        print("Account Deleted Successfully")
                    elif Pin != i[2]:
            ...
            print("contact to these numbers provided")
            print("9391899088 ,9440025408,7671030259")
            print("or else mail to these mails provided ")
            print("ramteja8985@gmail.com,arugondasaisathwik24@gmail.com,cheerlacharansagar@gmail.com")
        ...
        if choice == "1":
                ...
                if phone == i[1]:
                    ...
                    if Pin == i[2]:
                        ...
                        if int(transfer_amount) <= int(i[3]):
                            ...
                            receiver_phone = is_valid_phone(receiver_phone)
                            if receiver_phone == phone:
                                print("you are entering sender and reciver")
                            else:
                                for j in list_a:
                                    if receiver_phone == j[1]:
                                            i[3] = str(int(i[3]) - int(transfer_amount))
            ...
            print("contact to these numbers ")
            print("9391899088 ,9440025408,7671030259")
            print("or else mail to these ")
            print("ramteja8985@gmail.com,arugondasaisathwik24@gmail.com,cheerlacharansagar@gmail.com")
        ...
        print("1.Deposit\n2.Withdraw\n3.Check Balance \n4.Transfer monney to other branch version\n5.Transfer Money \n6.Delete Account \n7.change Pin \n8.Output all account details \n9.Change Account Name\n10.Change phone Number \n11.Return to Main Menu \n12.E commerce Shopping \n13.Apply for Loan \n14.Mobile Recharge \n15.Fixed Deposit \n16.Transfer my account to other Branch\n17.Forget Pin option\n18.contant support")
                ...
                if phone == i[1]:
                    ...
                    if Pin == i[2]:
                        ...
                        if int(transfer_amount) <= int(i[3]):
                            ...
                            receiver_phone = is_valid_phone(receiver_phone)
                            if receiver_phone == phone:
                                print("you are entering the same number sender and reciver")
                            else:
                                for j in list_b:
                                    if receiver_phone == j[1]:
                                        i[3] = str(int(i[3]) - int(transfer_amount))
                ...
                if phone == i[1]:
                    ...
                    if Pin == i[2]:
                        ...
                        if int(shopping_amount) <= int(i[3]):
                            ...
                            print("Shopping Amount Deducted Successfully")
                            print("Your New Balance is: ", i[3])
                            print("your cashback 0.3% is credeted to your Bank account")
                            i[3] = str(round(int(i[3]) + int(shopping_amount )* 3 / 1000))
                            print("Your New Balence is:", i[3])
                        else:
                            print("Insufficient Balance for Shopping")
                    elif Pin !=i[2]:
                        print(" Two ettemts Left")
                        print("Incorrect Pin ")
                        print("Try again")
                        Pin = input("Enter your Pin Number: ")
                        Pin = is_valid_Pin(Pin)
                        if Pin == i[2]:
                                    ...
                                    if int(shopping_amount) <= int(i[3]):
                                                ...
                                                print("Your New Balance is: ", i[3])
                                                print("your cashback 0.3% is credeted to your Bank account")
                                                i[3] = str(round(int(i[3]) + int(shopping_amount * 3 / 10)))
                                                print("Your New Balence is:", i[3])
                                    else:
                                                print("Insufficient Balance for Shopping")
                        elif Pin !=i[2]:
                            print("One ettempt Left")
                            print("incorrect Pin")
                            print("Try again")
                        Pin = input("Enter your Pin Number: ")
                        Pin = is_valid_Pin(Pin)
